...
<template>
  <div id="banner">
    <div class="row m-0">
      <div
        id="date-and-place-container"
        class="col-md-6 ms-auto order-2 order-md-1 align-content-center text-center text-md-start ps-md-5"
      >
...
#banner {
  ...
  font-family: var(--abeezee), sans-serif;
}
